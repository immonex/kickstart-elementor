 ...
 * @since 1.0.0
 */
class Native_Pagination_Widget extends \immonex\Kickstart\ForElementor\Components\Widgets\Widget_Base {
	...
	const WIDGET_HELP_URL          = 'https://docs.immonex.de/kickstart-for-elementor/#/elementor-immobilien-widgets/seitennavigation';
	...
	public function get_title() {
		return __( 'Pagination', 'immonex-kickstart-for-elementor' ) . self::NATIVE_POSTFIX;
	} // get_title
	...
	protected function add_keywords() {
		...
		$this->keywords = array_unique(
			array_merge(
				$this->keywords,
				[
					__( 'pagination', 'immonex-kickstart-for-elementor' ),
					__( 'navigation', 'immonex-kickstart-for-elementor' ),
				]
			)
		);
	} // add_keywords
