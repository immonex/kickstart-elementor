	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [ '{{WRAPPER}} .inx-team-agency-list__item-wrap' => 'width: {{SIZE}}{{UNIT}}' ],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .inx-team-agency-list__item-wrap' => 'padding-left: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} * + .uk-grid-margin, .uk-grid + .uk-grid, .uk-grid > .uk-grid-margin' => 'margin-top: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .inx-team-agency-list > .uk-grid' => 'margin-left: -{{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->start_controls_section(
			'section_agency_tile_frame_style',
			[
				'label' => _x( 'Agency Tile', 'real estate property', 'immonex-kickstart-for-elementor' ) .
		...
		$this->add_group_control(
			...
			[
				'name'      => 'agency_tile_field_border',
				'selector'  => '{{WRAPPER}} .inx-team-agency-list-item',
				'separator' => 'before',
			]
		);

		$this->add_responsive_control(
			'agency_tile_border_radius',
			[
				'label'      => __( 'Border Radius', 'immonex-kickstart-for-elementor' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem' ],
				'selectors'  => [
					'{{WRAPPER}} .inx-team-agency-list-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);

		$this->add_control(
			'agency_tile_box_shadow_type',
			[
		...
		$this->add_control(
			'agency_style_remove_native_box_shadow',
			[
				'type'      => \Elementor\Controls_Manager::HIDDEN,
				'default'   => '1',
				'selectors' => [
					'{{WRAPPER}} .inx-team-agency-list-item' => 'box-shadow: none',
				],
				'condition' => [
					'agency_tile_box_shadow_type' => 'disabled',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'      => 'agency_tile_box_shadow',
				'label'     => __( 'Box Shadow', 'immonex-kickstart-for-elementor' ) .
					' (' . __( 'Custom', 'immonex-kickstart-for-elementor' ) . ')',
				'selector'  => '{{WRAPPER}} .inx-team-agency-list-item',
				'condition' => [
					'agency_tile_box_shadow_type' => 'custom',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .inx-team-agency-list-item__body' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .inx-team-agency-list-item > div' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .inx-team-agency-list-item__body' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .inx-team-agency-list-item__body a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .inx-team-agency-list-item__body',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .inx-team-agency-list-item__footer' => 'height: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .inx-team-agency-list-item:not(.inx-team-agency-list-item--no-footer)' => 'padding-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .inx-team-agency-list-item__footer .inx-link.inx-gradient--type--action' => 'background: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .inx-team-agency-list-item__footer .inx-link' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .inx-team-agency-list-item__footer',
			]
		);
	} // register_controls
