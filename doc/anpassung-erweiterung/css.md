...
Die einfachste Form der individuellen Anpassung stellt das Überschreiben bzw. Erweitern der vordefinierten CSS-Stile dar. Die entsprechenden Klassennamen beginnen typischerweise mit dem Präfix *inx-* (Kickstart-Basis-Stile) bzw. *inx-e-* (Add-on-spezifische Stile).
