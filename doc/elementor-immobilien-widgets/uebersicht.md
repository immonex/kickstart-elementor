# Immobilien-Widgets für Elementor

## Immobilien-Detailansicht

- [Ausstattungsliste](ausstattungsliste)
- [Basisgalerie](basisgalerie)
- [Beschreibung](beschreibung) (Objekt, Lage, Ausstattung, Sonstiges)
- [Downloads & Links](downloads-und-links)
...
- [Titel](titel) (Immobilienbezeichnung)
- [Videogalerie 🄽](videogalerie)
- [Virtuelle 360° Tour 🄽](virtuelle-360-grad-tour)
- [Zimmer & Flächen](zimmer-und-flaechen)
- [Zustand & Erschließung](zustand-und-erschliessung)

## Immobilienlisten und Objektsuche

- [Filter/Sortierung 🄽](filter-sortierung)
- [Karussell 🄽](karussell) (Immobilien-Slider)
- [Liste (Grid) 🄽](liste-grid)
- [Seitennavigation 🄽](seitennavigation)
- [Suchformular 🄽](suchformular)
- [Übersichtskarte 🄽](uebersichtskarte)

## Kontakte und Agenturen (Team Add-on)
